...
public class SumOfPathNumbers
{
    ...
    public void Print_v1(TreeNode root)
    {
        ...
        Console.WriteLine(getAllPathNumberSum1(root, 0));
    }
    ...
    private int getAllPathNumberSum1(TreeNode root, int pathSum)
    {
        if (root == null)
        {
            return 0;
        ...
        return getAllPathNumberSum1(root.Left, pathSum) +
        getAllPathNumberSum1(root.Right, pathSum);
